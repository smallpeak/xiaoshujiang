...
``` java
java -Dserver.port=8080 -Dcsp.sentinel.dashboard.server=localhost:8080 -Dcsp.sentinel.app.type=1 -Dproject.name=nubia -Dcsp.sentinel.log.dir=D:\\idea-source\\sentinel-logs  -jar sentinel-dashboard-1.6.3.jar
```
